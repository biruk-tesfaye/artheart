...
<div>
	<div
		class="hidden md:flex rounded-lg p-1 gap-1 justify-center items-center border border-sys-outline-variant"
	>
		<button
			class="bg-[#C9BFFF24] rounded-md flex gap-2 justify-center
		items-center px-4 md:px-6 py-[6px] md:py-[10px] text-sys-on-surface
		...
		<button
		 ...
		 px-4 md:px-6 py-[6px] md:py-[10px] text-sys-on-surface
		 focus:ring-1 focus:ring-inset focus:ring-primary focus:outline-none
		 "
		>
			<Photo />
	...
	<div class="relative block md:hidden">
		<div class="inline-flex shadow-sm rounded-md divide-x divide-indigo-600">
			<div class="relative z-0 inline-flex shadow-sm rounded-md divide-x divide-indigo-600">
				<button
					...
					class="bg-sys-surface-variant rounded-md flex gap-2 justify-between items-center
                px-4 md:px-6 py-[6px] md:py-[10px] text-sys-on-surface
                focus:ring-1 focus:ring-inset focus:ring-primary focus:outline-none
                w-full
                "
		...
		<ul
			class="{isOpen
				? 'block'
				: 'hidden'} origin-top-right absolute z-10 right-0 mt-2 w-full rounded-md shadow-lg overflow-hidden bg-sys-surface-variant ring-1 ring-black ring-opacity-5 focus:outline-none"
			tabindex="-1"
			role="listbox"
		...
		>
			<button
				...
				id="listbox-option-0"
			>
				<div class="flex flex-col text-sys-on-surface">Characters</div>
			</button>
			...
			<button
				...
				id="listbox-option-0"
			>
				<div class="flex flex-col text-sys-on-surface">Artwork</div>
			</button>
		</ul>
	</div>
</div>
